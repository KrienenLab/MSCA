#!/bin/bash
#SBATCH -o ./job_outputs/slurm_3_pycistopics_impute_acc_%j.out
...
python3 /jukebox/krienen/victor/marm_hmba_atac_50k/scripts/3_pycistopics_impute_acc_nonneuron.py
