...
os.chdir("/jukebox/krienen/victor/marm_hmba_atac_50k/pycisTopic/neuron")
...
with open("/jukebox/krienen/victor/marm_hmba_atac_50k/pycisTopic/neuron/outs/imputed_acc_obj_geosketch_50kcells_marm_subcortex_neuron.pkl", "rb") as fp:
...
'''adata_atac = sc.read_h5ad("/jukebox/krienen/victor/marm_hmba_atac_downsampled/data/atac_neuron_geosketch_50kcells_marm_subcortex.h5ad", backed='r')
...
pickle.dump(
    cistopic_obj,
    open(os.path.join(out_dir, "cistopic_obj_geosketch_50kcells_marm_subcortex_neuron.pkl"),"wb")
)